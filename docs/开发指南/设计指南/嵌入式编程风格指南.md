 ...
 * @attention :
 *******************************************************************************
 *  Copyright (c) 2024 HotPot Team，Zhejiang University.
 *  All Rights Reserved.
 *******************************************************************************
 */
```
...
```c
// TODO(HotPot)：remove the "last visitors" feature
```
...
"fileheader.customMade"：{
  ...
  "custom_string_obkoro1_copyright"："  Copyright (c) ${now_year} HotPot Team，Zhejiang University.",
